...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Prof. Brig (R) Dr. Shahid Mahmud — Top Pediatrician, Neonatologist & Child Neurologist. Expert care for newborns, infants & children. Book an appointment today." },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/clinic-logo.png" },
      { rel: "apple-touch-icon", href: "/clinic-logo.png" },
